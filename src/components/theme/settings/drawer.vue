...
<template>
  <section class="m_setting">
    ...
    <el-drawer
      ...
      :before-close="close">
      <!-- 主要布局 -->
      <p class="m_setting_label"><span class="m_setting_label_spot">* </span>布局选择</p>
      <div class="m_setting_value m_theme_contain">
        <span :class="themeConfig.layout === 'vertical' ? 'm_setting_value_active' : ''" class="m_setting_theme">
          <img 
        ...
        <span :class="themeConfig.layout === 'horizontal' ? 'm_setting_value_active' : ''" class="m_setting_theme m_setting_theme_small">
          <img 
      ...
      <!-- 主题的选择 -->
      <p class="m_setting_label"><span class="m_setting_label_spot">* </span>菜单模式</p>
      <div class="m_setting_value m_theme_contain">
        <span
      ...
      <!-- dark主题下的颜色选择 -->
      <p class="m_setting_label"><span class="m_setting_label_spot">* </span>深模式颜色选择</p>
      <div class="m_setting_value m_theme_contain">
        ...
        <span class="theme_color_label theme_color_label_last">active背景色: </span>
        <my-color-picker
      ...
      <!-- 主题色的选择 -->
      <p class="m_setting_label"><span class="m_setting_label_spot">* </span>主题色选择</p>
      <div class="m_setting_value m_theme_contain">
        <my-theme-picker 
  ...
  export default {
    ...
    methods: {
      ...
      changeLayout(type, layout) {
        ...
        switch (layout) {
          case 'vertical':
            this.setThemeConfig({prop: 'layoutComponent', value: 'header_menu_layout'})
            break;
          case 'horizontal':
            this.setThemeConfig({prop: 'layoutComponent', value: 'header_layout'})
...
<style lang="scss" scoped>
  ...
  .m_setting {
    ...
    // 菜单模式颜色选择样式(动画效果)
    .mode-color-enter-active, .mode-color-leave-active {
      // height: 91px .5s;
      opacity: 1 .5s;
    }
    .mode-color-enter, .mode-color-leave-to {
      // height: 0;
      opacity: 0;
    }
  }
